...
// Logger is logger's methods interface
...
// NewApiLogger is App Logger constructor
func NewApiLogger(cfg *config.Config) *apiLogger {
	return &apiLogger{cfg: cfg}
}

// loggerLevelMap is for mapping config logger to app logger levels
...
// getLoggerLevel gets logger level from config
